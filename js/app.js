(() => {
    ...
    function initSliders() {
        if (document.querySelector(".seo-stage__slider")) new core(".seo-stage__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            on: {
                init: function(swiper) {
                    ...
                    const allSlidesItems = document.querySelectorAll(".seo-stage__slide:not(.swiper-slide-duplicate)");
        ...
        if (document.querySelector(".first-result__slider")) new core(".first-result__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
        ...
        if (document.querySelector(".images-team")) {
            let thumbsSwiper = new core(".preview-team__slider", {
        ...
        if (document.querySelector(".case-page__slider")) new core(".case-page__slider", {
            ...
            loop: true,
            pagination: {
                el: ".pagination-case-page__dotts",
                clickable: true
            },
            navigation: {
                prevEl: ".swiper-button-prev",
